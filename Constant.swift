...
class Constant: NSObject {
    ...
    struct GlobalConstants {
        ...
        static let kIphone_7 : Bool =  (UIScreen.main.bounds.size.height == 736)
        static let kIphone_7_Plus : Bool =  (UIScreen.main.bounds.size.height == 736)
    ...
    struct DeviceType
    {
        ...
        static let IS_IPHONE_X         = IS_IPHONE_6P && ScreenSize.SCREEN_MAX_LENGTH == 812.0
