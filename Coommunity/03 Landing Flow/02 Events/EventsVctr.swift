...
class EventsVctr: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let center = CLLocationCoordinate2D(latitude: 23.061667, longitude: 72.519342) // region center
...
extension EventsVctr: MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        if let annotation = annotation as? ClusterAnnotation {
            ...
            if let view = view as? BorderedClusterAnnotationViews {
                view.annotation = annotation
                view.configure(with: style)
            } else {
                view = BorderedClusterAnnotationViews(annotation: annotation, reuseIdentifier: identifier, style: style, borderColor: .white)
            }
            return view
        } else {
...
class BorderedClusterAnnotationViews: ClusterAnnotationView {
